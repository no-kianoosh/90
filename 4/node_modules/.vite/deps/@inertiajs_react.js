import {
  ...
  shouldNavigate,
  useInfiniteScroll
} from "./chunk-7KIJGNKX.js";
import "./chunk-MSFGAGFO.js";
import {
  require_react
...
function usePage() {
  const page = (0, import_react6.useContext)(PageContext_default);
  if (!page) {
...
var Deferred = ({ children, data, fallback }) => {
  ...
  const keys = (0, import_react5.useMemo)(() => Array.isArray(data) ? data : [data], [data]);
...
function useForm(rememberKeyOrInitialValues, maybeInitialValues) {
  ...
  const isDirty = (0, import_react8.useMemo)(() => !isEqual_default(data, defaults), [data, defaults]);
    ...
    (fieldOrFields, maybeValue) => {
      ...
      if (typeof fieldOrFields === "undefined") {
        ...
        setDefaults((defaults2) => {
          return typeof fieldOrFields === "string" ? set_default(cloneDeep_default(defaults2), fieldOrFields, maybeValue) : Object.assign(cloneDeep_default(defaults2), fieldOrFields);
        });
      }
    },
    [setDefaults]
  ...
  const reset = (0, import_react8.useCallback)(
    (...fields) => {
      if (fields.length === 0) {
        ...
        setData(
          (data2) => fields.filter((key) => has_default(defaults, key)).reduce(
            (carry, key) => {
              return set_default(carry, key, get_default(defaults, key));
            },
            { ...data2 }
          )
        );
...
var InfiniteScroll = (0, import_react11.forwardRef)(
  ({
    ...
    const scrollableParent = (0, import_react11.useMemo)(() => getScrollableParent(resolvedItemsElement), [resolvedItemsElement]);
